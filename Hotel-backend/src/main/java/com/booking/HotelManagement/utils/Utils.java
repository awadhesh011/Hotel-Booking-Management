package com.booking.HotelManagement.utils;

import com.booking.HotelManagement.dto.BookingDTO;
...
//        room.setRoomPhotoUrl(room.getRoomPhotoUrl());
//        return roomDTO;
//    }
public static RoomDTO mapRoomEntityToRoomDTO(Room room) {
    ...
    dto.setRoomPhotoUrl(room.getRoomPhotoUrl()); // ✅ Cloudinary URL included

    if (room.getBookings() != null) {
        List<BookingDTO> bookingDTOs = room.getBookings().stream()
                .map(Utils::mapBookingEntityToBookingsDTO)
                .toList();
    ...
    public static RoomDTO mapRoomEntityToRoomDTOPlusBookings(Room room){
        ...
        if(room.getBookings() != null){
            roomDTO.setBookings(room.getBookings().stream().map(Utils::mapBookingEntityToBookingsDTO).toList());
        }

        return roomDTO;
    }

    public static UserDTO mapUserEntityToUserDTOPlusUsersBookingAndRoom(User user){
        UserDTO userDTO = new UserDTO();
